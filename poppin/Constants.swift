...
let parties = [
    Party(name: "Cafe Disco", bannerImageURL: URL(string: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8Mnx8fGVufDB8fHx8fA%3D%3D") ?? URL(fileURLWithPath: ""), price: 0, startDate: Date(), endDate: Date().addingTimeInterval(5 * 3600)),
    Party(name: "Game of Grooves", bannerImageURL: URL(string: "https://media.istockphoto.com/id/1277125124/photo/falling-gold-glitter-christmas-celebration-anniversary-background.webp?b=1&s=170667a&w=0&k=20&c=WSKKk9woYJn3dIEyiwmMOgwLTxVDjo_74r0AtUKe3Ok=") ?? URL(fileURLWithPath: ""), price: 24.99, startDate: Date(), endDate: Date().addingTimeInterval(864000)),
    Party(name: "Meme Team Mixer", bannerImageURL: URL(string: "https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8fA%3D%3D") ?? URL(fileURLWithPath: ""), price: 20, startDate: Date(), endDate: Date().addingTimeInterval(10 * 3600))
]
